...
class Prestamo:
    ...
    def __init__(self, usuario, libro):
        ...
        self.estado_devolucion = None  # Nuevo atributo
...
class Biblioteca:
    ...
    def prestar_libro(self, id_usuario, id_libro):
        ...
        # Guardar préstamo y actualizar estado del libro
    ...
    def eliminar_historial_prestamos(self):
        ...
        if confirmacion == 's':
            try:
                # Eliminar todos los archivos de préstamos
                ...
                # Limpiar la lista de préstamos en memoria
                self.prestamos.clear()
                
                # Limpiar los préstamos de todos los usuarios
                for usuario in self.usuarios.values():
...
def crear_directorios():
    ...
    directorios = [CARPETA_LIBROS, CARPETA_USUARIOS, CARPETA_PRESTAMOS]
...
def mostrar_menu():
    ...
    print("14. Eliminar Historial de Préstamos")
    print("\n--- SISTEMA ---")
